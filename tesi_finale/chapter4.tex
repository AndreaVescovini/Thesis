...
\begin{figure}
	\centering
	\includegraphics[width=\textwidth]{rough_channel_one_step_arrows2.png}
...
%, running unsteady simulations, the solution settles down and becomes reasonably steady (quasi-steady).
...
%wall friction is not highly affecting the velocity as it is in the
effect of wall friction is lower with respect to
other sections and this allows the velocity to 
reach higher values.
%When a cavity is over and the wall begins,
...
After the distance $d_{rec}$, the value of the velocity observed 
