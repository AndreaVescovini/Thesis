...
The convergence of higher 
order methods is tested, first in space, 
...
compared to those from the CFL3D code from \cite{web:nasa}. Finally, a 
turbulent flow through a channel with two small cavities is studied.
