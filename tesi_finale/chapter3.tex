...
\begin{itemize}
	...
	value at the centre of the cell. The derivatives appearing in the 
	entries of $\mathbf{S}$, $\nabla k$ and $\nabla \omega$ are computed with 
...
\begin{figure}
	...
	presented in this 
	section as functions of $r$. In grey the area that is allowed in order to 
	have a TVD method.}
