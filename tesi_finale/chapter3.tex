...
\begin{figure}
	\centering
	\includegraphics[width=0.4\textwidth]{coupled_cells.pdf}
...
is the approximation of $p_\text{pm}^\text{ff}$. This is done reverting 
...
velocity.
%
\section{Resulting algebraic equations}
