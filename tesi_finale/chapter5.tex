...
temporal discretization, we have available an high order discretization both in 
...
because of the first cavity does not influence anymore the behaviour around the 
